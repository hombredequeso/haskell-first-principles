...
numStr = "123"
-- try this:
--      decode numStr :: Maybe NumberOrString

floatStr :: ByteString
floatStr = "123.456"
--      decode floatStr :: Maybe NumberOrString

strStr :: ByteString
strStr = "definitelyNotANumber"
--      decode strStr :: Maybe NumberOrString

quotationEnclosedStr :: ByteString
quotationEnclosedStr = [r|"stringInQuotes"|]
--      decode quotationEnclosedStr :: Maybe NumberOrString
